defmodule Chats.Auth do
    ...
    alias Chats.Helpers.MapHelper
    
    @app_secret_key Application.get_env(:chats, :app_secret_key)
    @jwt_validity Application.get_env(:chats, :jwt_validity)
